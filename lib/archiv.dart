...
class CalameoArchivAusgabenList extends StatelessWidget {
...
class ArchivAusgaben extends StatefulWidget {
  @override
  _ArchivAusgabenState createState() => _ArchivAusgabenState();
}

class _ArchivAusgabenState extends State<ArchivAusgaben> {
